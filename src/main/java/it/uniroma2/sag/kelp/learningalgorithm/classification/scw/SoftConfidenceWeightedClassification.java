...
public class SoftConfidenceWeightedClassification implements
	 ...
	 */
	private it.uniroma2.sag.kelp.learningalgorithm.classification.scw.SCWType scwTypee = it.uniroma2.sag.kelp.learningalgorithm.classification.scw.SCWType.SCW_II;
	 ...
	 *            training step
	 */
	public SoftConfidenceWeightedClassification(it.uniroma2.sag.kelp.learningalgorithm.classification.scw.SCWType scwTypee, float eta,
	 ...
	 *            training step
	 */
	public SoftConfidenceWeightedClassification(Label label, it.uniroma2.sag.kelp.learningalgorithm.classification.scw.SCWType scwTypee,
	 ...
	 */
	public it.uniroma2.sag.kelp.learningalgorithm.classification.scw.SCWType getScwType() {
		return scwTypee;
	}
	...
	public BinaryMarginClassifierOutput learn(Example example) {
		...
		if (lossValue > 0) {
			...
			float alpha = 0;
			// SCW1
			if (scwTypee == it.uniroma2.sag.kelp.learningalgorithm.classification.scw.SCWType.SCW_I) {
	 ...
	 *            The type of SCW learning algorithm (SCW-I or SCW-II)
	 */
	public void setScwType(it.uniroma2.sag.kelp.learningalgorithm.classification.scw.SCWType scwTypee) {
		this.scwTypee = scwTypee;
	}
