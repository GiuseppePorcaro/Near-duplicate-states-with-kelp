...
public class MainClass {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String datasetDB = "/home/giuseppeporcaro/Documenti/GitHub/Near-duplicate-states-with-kelp/src/main/resources/data/gs_full_dom_mu01_kernels_StarDomRepresentation_weightedSim_refinedAttr.db";
        DatasetManager datasetManager = new DatasetManager(folderPath,datasetDB,97490,"weightedRefinedSimilarity");
